...
class ActaTallerController extends Controller
{
    ...
    /**
     * Placas disponibles para abrir/filtrar un acta de taller: incluye tanto
     * camiones como carretas, ya que "placa" en actas_taller es un campo
     * libre sin FK — sirve indistintamente para ambos.
     */
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $acta = DB::transaction(function () use ($data, $request) {
            $acta = ActaTaller::create([
                ...
                'contacto_taller' => $data['contacto_taller'] ?? null,
    ...
    public function dashboard(Request $request): Response
    {
        ...
        $vencidas = $actas->filter(fn ($a) => $a->estado_acta === 'en_taller' &&
